...
//   isOpen: boolean;
//   onClose: () => void;
//   initialData: Category | null; // Thêm prop này để nhận dữ liệu khi Sửa
// }

// export const AddCategoryModal = ({ isOpen, onClose, initialData }: Props) => {
//   // State quản lý dữ liệu form
//   const [name, setName] = useState("");
//   const [description, setDescription] = useState("");
//   const [status, setStatus] = useState("Active");

//   // Tự động điền dữ liệu khi bấm vào nút "Cây viết" (Sửa)
//   useEffect(() => {
...
//   const isEdit = !!initialData; // Kiểm tra đang là chế độ Sửa hay Thêm
...
//         {/* Header - Đổi tiêu đề và icon linh hoạt */}
