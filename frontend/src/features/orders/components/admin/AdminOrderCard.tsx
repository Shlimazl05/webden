...
//   CreditCard, ChevronDown, Coins, ShoppingBag, 
//   Receipt, CheckCircle2, XCircle, PackageCheck,
//   StickyNote, Hash, AlertCircle, Timer
// } from 'lucide-react';
// import { OrderStatusBadge } from '../OrderStatusBadge';
// import { IOrder, OrderStatus } from '../../order.types';
// import { OrderStatusTimeline } from '../OrderStatusTimeline'; 
...
//           } else {
//             setTimeLeft("Đơn hàng đã quá hạn thanh toán");
//           }
//         };
//         updateTimer();
...
//   return (
//     <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden mb-6 transition-all hover:shadow-xl group">
...
//                 <CreditCard size={16} strokeWidth={2.5} className="text-emerald-500" />
//               </div>
//               {/* <span className="text-slate-700 font-black text-[15px] uppercase">{order.paymentMethod}</span> */}
...
//   {/* HIỆN THÔNG BÁO THIẾU TIỀN CHO SEPAY */}
...
//           {/* BANNER THÔNG BÁO THỜI GIAN CÒN LẠI / THANH TOÁN THIẾU */}
...
//               </div>
//               <div>
//                 <p className="text-[14px] font-black leading-tight uppercase tracking-tight">
//                   {order.paymentStatus === 'Partially_Paid' ? 'Đang chờ thanh toán bổ sung' : 'Thông tin thời hạn'}
//                 </p>
...
//                       <div><p className="text-[10px] font-bold text-slate-400 uppercase mb-1">Số điện thoại</p><p className="text-[16px] font-black text-slate-900">{order.phone}</p></div>
//                     </div>
//                     <div className="bg-slate-50 p-4 rounded-2xl flex items-start gap-3">
//                       <MapPin size={18} strokeWidth={2.5} className="text-rose-500 mt-1" />
//                       <div><p className="text-[10px] font-bold text-slate-400 uppercase mb-1">Địa chỉ nhận hàng</p><p className="text-[15px] font-bold text-slate-700 leading-snug">{order.address}</p></div>
//                     </div>
//                 </div>
//              </div>
...
//                    <p className="text-[14px] font-bold text-slate-600 italic leading-relaxed">"{order.note || "Khách hàng không để lại lời nhắn."}"</p>
//                 </div>
//              </div>
//           </div>

//           {/* Bảng sản phẩm và Timeline */}
//           <div className="space-y-6 pt-10 border-t border-slate-50">
...
//                         <td className="px-8 py-6">
//                           <div className="flex items-center gap-6">
//                              <div className="w-16 h-16 rounded-2xl border border-slate-100 overflow-hidden bg-slate-50 p-1">
//                                 <img src={item.productId?.imageUrl} className="w-full h-full object-cover rounded-xl" />
//                              </div>
//                              <div>
...
//                       <div className="flex justify-between items-center">
//                         <div className="flex items-center gap-2"><Receipt size={18} strokeWidth={3} className="text-rose-600" /><span className="text-[14px] font-black text-slate-900 uppercase">Tổng cộng</span></div>
//                         <span className="text-3xl font-black text-rose-600 tracking-tighter leading-none">{order.finalAmount?.toLocaleString()}đ</span>
//                       </div>
//                    </div>
//                 </div>
