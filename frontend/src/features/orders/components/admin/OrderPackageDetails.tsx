...
// interface Props {
//     order: IOrder;
//     isClientView?: boolean; // Thêm dòng này (dấu ? để không bắt buộc Admin phải truyền)
// }

// export const OrderPackageDetails: React.FC<{ order: IOrder }> = ({ order, isClientView = false }: Props) => {
//     return (
