...
//   /**
//    * Logic Debounce: Tránh gọi API liên tục khi đang gõ phím
//    */
//   useEffect(() => {
...
//   // Tự động gọi lại khi trang hoặc từ khóa thay đổi
//   useEffect(() => {
...
//       await fetchOrders(1, ""); // Tải lại trang đầu tiên sau khi tạo
//     } catch (err) {
//       throw err; // Để Modal bắt lỗi và hiển thị toast.error
//     }
//   };

//   /**
//    * Thực hiện xóa hóa đơn và cập nhật kho
//    */
//   const executeDelete = async () => {
//     if (!selectedId) return;
//     try {
//       await importOrderApi.delete(selectedId);
//       toast.success("ĐÃ XÓA VÀ CẬP NHẬT LẠI KHO", {
//         style: { borderRadius: '12px', background: '#1e293b', color: '#fff' }
//       });
      
//       // Nếu xóa hết dòng ở trang hiện tại, lùi về trang trước
...
//       }
//     } catch (err: any) {
//       toast.error(err.response?.data?.message || "KHÔNG THỂ XÓA PHIẾU NÀY");
//     } finally {
