...
export const ProductDetailContent = ({ product }: { product: IProduct }) => {
    ...
    return (
        ...
        <div className="space-y-6 animate-in fade-in duration-700 max-w-[1200px] mx-auto pt-10 lg:pt-16 pb-10 px-4">

            {/* 1. KHUNG BAO CHÍNH */}
            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden p-6 lg:p-10">
