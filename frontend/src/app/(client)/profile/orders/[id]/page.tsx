...
//   // Dữ liệu mẫu (Khớp 100% IOrder của sơ đồ lớp)
...
//         <button onClick={() => router.back()} className="flex items-center gap-2 text-slate-400 hover:text-indigo-600 transition-all text-xs font-black uppercase tracking-widest">
...
//         {/* Cột 1: Thông tin (1/3 độ rộng) */}
//         <div className="lg:col-span-1">
//           <OrderInfoCard order={mockOrder} />
//         </div>

//         {/* Cột 2: Sản phẩm & Bill (2/3 độ rộng) */}
...
//              <button className="px-8 py-3 rounded-2xl border-2 border-slate-100 text-xs font-black text-slate-400 hover:border-indigo-400 hover:text-indigo-600 transition-all">LIÊN HỆ HỖ TRỢ</button>
//              <button className="px-8 py-3 rounded-2xl bg-indigo-600 text-white text-xs font-black hover:bg-indigo-700 shadow-xl shadow-indigo-100 transition-all">MUA LẠI ĐƠN HÀNG</button>
//           </div>
//         </div>
//       </div>
//     </div>
