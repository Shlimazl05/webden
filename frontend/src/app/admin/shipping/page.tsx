...
export default function ShippingPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* 1. KHUNG CỐ ĐỊNH CHÍNH (Giống hệt trang đơn hàng) */}
            <div className="max-w-6xl mx-auto bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden min-h-[85vh] flex flex-col relative mt-8">
                ...
                {/* 2. Header: Tiêu đề trang (Căn chỉnh lại padding p-8) */}
                <div className="p-8 pb-0">
                    ...
                    <p className="text-slate-500 font-bold ml-11 text-sm">
                        Tự động thay đổi phí giao hàng dựa trên giá trị giỏ hàng
                    </p>
                </div>
                ...
                <div className="p-8 space-y-8 animate-in fade-in duration-500">
                    ...
                    <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
                        ...
                        <div className="divide-y divide-slate-50">
                            {isLoading ? (
                                <div className="p-20 text-center font-black text-slate-200 tracking-widest uppercase text-sm">
                                    Đang tải dữ liệu...
                                </div>
                            ) : (
                                rules.map((rule: any, index: number) => (
                                    <div key={rule._id} className="p-6 flex items-center justify-between hover:bg-slate-50/50 transition-all group">
                                        ...
                                        <button
                                            onClick={() => requestDelete(rule._id)}
                            ...
                            {!isLoading && rules.length === 0 && (
                                <div className="p-20 text-center font-bold text-slate-300 italic text-sm">
                                    Chưa có cấu hình phí vận chuyển nào.
                                </div>
                            )}
                        </div>
