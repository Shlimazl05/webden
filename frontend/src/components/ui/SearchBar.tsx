...
//   placeholder?: string; // Prop để tái sử dụng chữ gợi ý
// }
...
//         className="w-full h-11 pl-12 pr-6 bg-slate-50 border border-slate-100 rounded-full outline-none text-sm font-bold text-[#001529] placeholder:text-slate-400 focus:bg-white focus:ring-2 focus:ring-indigo-100 focus:border-indigo-200 transition-all shadow-sm"
//       />
//     </div>
//   );
// };
